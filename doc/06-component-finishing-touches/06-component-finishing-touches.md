...
I think that this project gave me a much better understanding of software development.  I was able to develop a component that has a direct application to a thing in the real world.  While I do see the value in components that we've learned about, they seem to have more use in developing other components rather than being used significantly in a project applicable to the real world.  This project allowed me to design something that maps well to the real world, while learning more about the bumps along the road in the programming process.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

The programming project gave me a better understanding about the structure of classes, and it gave me a better understanding about certain important concepts in java, like how to implement an iterator.  In addition, it allowed me to apply what I've learned so far in a different context than normal, which required me to think about the applications of different programming concepts in ways that I haven't had to before.  When I struggled in this project, I had to do research to determine the best way to implement functions, which taught me a lot about the programming process.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

I still enjoy software development after this project.  I think it is very satisfying to see the culmination of months of hard work in this project. I am very happy with how my component turned out, and I may even continue working on this project (even if that means recreating it in a different setting, like through databases or other programming language).
...
As for software skills, I got better at reading APIs (CSE component APIs) and reading/understanding other people's code (CSE component implementations).  As for non software skills, I improved at problem solving/critical thinking, researching and learning in an individual setting, anticipating user needs, and documenting my process.
...
I am still not completely sure what I want to do with my career, but I want to do something related to software development.  This component is a project that I have wanted to do for a while.  Before designing this, I was already considering adding a business analytics minor, which would require me to take a couple of database CSE classes.  After completing this project, I am more interested in this as this project would lend itself very well to integration with a database.
...
The most important thing to continue on my career trajectory will be to continue working hard in my classes and developing other "passion projects" outside of class.  These voluntary development projects will serve as a valuable supplement to what I am learning while allowing me to develop my portfolio.  As for mentors, I will continue to learn from my professors and peers, and I hope to apply for internships that will allow me to build connections within the industry.  In addition, I will continue participating in events like hackathons and other extracurricular activities to develop my skills alongside my peers.
