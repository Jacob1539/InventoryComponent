...
-I changed the remove kernel method so that it now returns an InventoryItem object
-I added a removeAny and size method to the kernel
-I added a contains kernel method to check preconditions
...
I'm still a little bit confused about how to implement a couple of my methods, so I'll probably go to office hours to discuss these.  I wanted to submit this version so that I could get some initial feedback.
