...
complete a kernxcel implementation, just like you've done so many times already.
...
I will use a map to represent my component.  This is because each barcode (key) has a corresponding inventoryItem (value)
